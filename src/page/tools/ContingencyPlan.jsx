...
export default function ContingencyPlan() {
    ...
    return (
        ...
        <div>
            ...
            <p>Welcome to your Contingency Plan, a tool designed to help you prepare for life’s financial uncertainties and mitigate their effects. This tool will walk you through the key protective measures of an emergency fund and life insurance.</p>

            <h4 className="fs-5 mb-3 mt-3">How to Use This Tool:</h4>
            <ol>
                <li>
                    <strong>Define Emergency:</strong> Identify the specific situations in which it would be appropriate to use your emergency fund.
                </li>
                <li>
                    <strong>Size Your Emergency Fund:</strong> Estimate how much money you need in your emergency fund.
                </li>
                <li>
                    <strong>Open Your Emergency Fund:</strong> Decide where you’ll store your fund and begin placing funds there.
                </li>
                <li>
                    <strong>Size Your Life Insurance:</strong> Calculate how much life insurance coverage you need.
                </li>
                <li>
                    <strong>Purchase a Policy:</strong> Research policies and find the best one for you.
                </li>
            </ol>
