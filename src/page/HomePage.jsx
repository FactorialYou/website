            ...
            <section id="services" class="services section-bg">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                            <div class="icon-box iconbox-orange">
                                ...
                                <a href="/Workshop" class="service-btn orange-service-btn">Learn More</a>
                            </div>
                        </div>

                        <div class="col-lg-3 col-md-6 col-12 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                            <div class="icon-box iconbox-blue">
                                ...
                                <a href="/Tools" class="service-btn blue-service-btn">Explore</a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                            <div class="icon-box iconbox-pink">
                                ...
                                <a href="/Articles" class="service-btn pink-service-btn mb-0">Explore</a>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                            <div class="icon-box iconbox-teal">
                                ...
                                <a href="/Coaching" class="service-btn teal-service-btn">Learn More</a>
                            </div>
                        </div>
